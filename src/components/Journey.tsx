...
const Journey: React.FC = () => {
  const timelineItems = [
		...
		},
		{
			...
			title: 'Dub.it',
			location: 'Ogden, UT',
			description: 'Developed a tool that hijacks videos and overlays a dub on top of it with a selected voiceover profile.',
			technologies: ['HTML', 'javascript', 'Supabase', 'Tailwindcss'],
		},
		{
			year: 'Sept 2025',
			type: 'project',
			...
			title: 'iSpy',
			location: 'Tempe, AZ',
			description: 'Developed a web app that allows the uploads of vehicle damage claims (images) and uses vision models to detect if the claim is fraudulent or not.',
			technologies: ['React', 'Typescript', 'Tailwindcss', 'Hugging Face', 'Render', 'Supabase'],
		},
    {
      year: 'May - Sept 2025',
      type: 'experience',
